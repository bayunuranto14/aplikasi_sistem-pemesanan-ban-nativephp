...
<head>
    ...
    <link rel="stylesheet" href="../pages/assets/dark-mode.css">
            ...
            <nav class="nav my-auto justify-content-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item hover:bg-cyan-400 hover:text-white font-semibold" href="#">Login</a>
                ...
                <div class="nav-link d-flex">
                    <img class="mr-2 hover:bg-white" width="25px" ; src="./assets/sun.png" alt="">
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="darkSwitch">
                        <label class="custom-control-label " for="darkSwitch">
                        </label>
                    </div>
                    <img class="mr-auto hover:bg-black" width="25px" ; src="./assets/moon.png" alt="">
                </div>
            </nav>
        </header>