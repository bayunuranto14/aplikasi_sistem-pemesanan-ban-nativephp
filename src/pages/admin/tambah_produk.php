...
if (isset($_POST['save'])) {
    ...
    $koneksi->query("INSERT INTO produk(nama_produk, harga, merk, jumlah_stok, deskripsi, gambar) VALUES('$_POST[nama_produk]', '$_POST[harga]', '$_POST[merk]', '$_POST[jumlah_stok]', '$_POST[deskripsi]', '$_POST[gambar]')");
